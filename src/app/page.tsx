...
type Space = { id?: string | number; name?: string; [k: string]: any };
...
export default function HomePage() {
    ...
    const onCreate = async (e: React.FormEvent) => {
        ...
        await createSpace(newSpace.trim());
        setNewSpace('');
        await load();
    };
    ...
    return (
        <div>
            ...
            <form onSubmit={onCreate} style={{display: 'flex', gap: 8, marginBottom: 16}}>
                ...
                />
                <button type="submit" className="border-1 p-2 hover:cursor-pointer">Create</button>
            </form>
